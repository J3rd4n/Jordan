window.loadLevelData({
    ...
    movingPlatforms: [
        { x: 380, y: 470, width: 100, height: 20, startX: 380, endX: 480, speed: 2.5 }
    ],
    enemies: [
        { x: 690, y: 460, width: 30, height: 30, startX: 690, endX: 770, speed: 2.5 }
    ],
    teleporters: [
        { x: 580, y: 380, width: 40, height: 60, targetX: 780, targetY: 420 }
    ],
    iceBlocks: [
        { x: 580, y: 470, width: 100, height: 20 }
    ],
    lava: [
        { x: 780, y: 560, width: 100, height: 20 }
    ]
});